...
Custom exception hierarchy for NovaInsight.
...
Both inherit from NovaInsightError so callers can do isinstance(e, NovaInsightError).
"""
from __future__ import annotations


class NovaInsightError(Exception):
    """Root exception for all NovaInsight errors."""
...
class ModuleError(NovaInsightError):
    """
...
class PipelineError(NovaInsightError):
