...
class TestReportGeneratorRun:
    ...
    def test_run_sets_html_report_path(self, test_config, bare_report, titanic_small_df, run_profiler):
        report = run_profiler(test_config, titanic_small_df, bare_report)
        rg = ReportGenerator(test_config)
        rg.run(titanic_small_df, report)
    ...
    def test_html_contains_report_title(self, test_config, bare_report, titanic_small_df, run_profiler):
        report = run_profiler(test_config, titanic_small_df, bare_report)
        rg = ReportGenerator(test_config)
        rg.run(titanic_small_df, report)
    ...
    def test_empty_plots_renders_without_crash(self, test_config, bare_report, titanic_small_df, run_profiler):
        report = run_profiler(test_config, titanic_small_df, bare_report)
    ...
    def test_is_completed_true_after_run(self, test_config, bare_report, titanic_small_df, run_profiler):
