...
from sleuth.exceptions import LLMSummarizerError, ModuleError
from sleuth.llm.factory import create_provider
from sleuth.llm.prompts import build_correction_messages, build_messages
...
class LLMSummarizer(BaseModule):
    ...
    def _initialize_provider(self) -> None:
        if not self.config.llm.api_key:
            raise ModuleError("LLM Summarizer skipped: SLEUTH_LLM_API_KEY not set")
        try:
