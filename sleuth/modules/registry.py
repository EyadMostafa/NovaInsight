...
Adding a new module only requires:
  1. Sleuth/modules/my_module.py  — class + @register_module decorator
...
from sleuth.schemas.analysis_report import AnalysisReport, Operator
from sleuth.utils.logger import get_logger

logger = get_logger("sleuth.modules.registry")
